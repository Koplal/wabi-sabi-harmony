...
const SeasideEstate = () => {
  ...
  const packageItem = {
    ...
    price: 1924,
    description: 'Resort-Style Summer Elegance',
    image: heroImage,
  };
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  "Premium coastal wreath collection (3+, custom-designed)",
                  "12 Luxury summer arrangements with tropical plants",
                  "Large driftwood installations as art pieces",
                  "Professional nautical styling with maritime elements",
                  "Multiple lantern displays throughout",
                  "Natural fiber furniture accents (wicker, rattan)",
                  "Beach-inspired ambient lighting design",
                  "Tropical plant arrangements (palms, banana leaves)",
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <Card className="p-6">
                  ...
                  <Button size="sm" variant="outline" className="w-full"
                    onClick={() => addToCart({id: 'seaside-estate-removal', name: 'Post-Season Removal', price: 99, description: 'Complete cleanup and disposal', image: heroImage})}>
                    Add to Cart
                  </Button>
                </Card>
                <Card className="p-6">
