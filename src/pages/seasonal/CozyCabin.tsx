            ...
            <div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <Card className="p-6">
                  ...
                  <p className="text-muted-foreground mb-4">Extend warm lighting throughout display</p>
                  <Button 
                    size="sm" 
                    variant="outline" 
                    className="w-full"
                    onClick={() => addToCart({
                      id: 'cozy-cabin-candles',
                      name: 'Additional LED Candles (4)',
                      price: 75,
                      description: 'Extend warm lighting throughout display',
                      image: heroImage,
                    })}
                  >
                    Add to Cart
