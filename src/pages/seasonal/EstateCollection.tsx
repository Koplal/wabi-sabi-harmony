              ...
              <div className="grid md:grid-cols-3 gap-6">
                <Card className="p-6">
                  ...
                  <Button size="sm" variant="outline" className="w-full"
                    onClick={() => addToCart({id: 'estate-collection-removal', name: 'Post-Halloween Removal & Composting', price: 99, description: 'Complete cleanup and eco-friendly disposal', image: heroImage})}>
                    Add to Cart
                  </Button>
                </Card>
                <Card className="p-6">
                  ...
                  <Button size="sm" variant="outline" className="w-full"
                    onClick={() => addToCart({id: 'estate-collection-pumpkins', name: '24 Mini Pumpkins', price: 75, description: 'Additional miniature pumpkins for enhanced detail', image: heroImage})}>
                    Add to Cart
                  </Button>
                </Card>
                <Card className="p-6">
                  ...
                  <Button size="sm" variant="outline" className="w-full"
                    onClick={() => addToCart({id: 'estate-collection-aromatherapy', name: 'Seasonal Aromatherapy Spray', price: 35, description: 'Natural autumn scent to complement your display', image: heroImage})}>
                    Add to Cart
                  </Button>
                </Card>
              </div>
