            ...
            <Accordion type="single" collapsible className="space-y-4">
              ...
              <div className="mb-8">
                ...
                <AccordionItem value="unique">
                  <AccordionTrigger className="text-left">
                    What makes Wabi Sabi Services different?
                  </AccordionTrigger>
                ...
                <AccordionItem value="specialized">
                  ...
                  <AccordionContent className="text-muted-foreground leading-relaxed">
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li><strong>Move-In/Move-Out:</strong> Full transition cleaning, top to bottom</li>
              ...
              <div className="mb-8">
                ...
                <AccordionItem value="neighbourhoods-near-me">
                  ...
                  <AccordionContent className="text-muted-foreground leading-relaxed">
                    We serve Greater Victoria's most discerning enclaves — Uplands, Oak Bay, Rockland, Ten Mile Point, Cadboro Bay, Willis Point, North Saanich, and more. Explore the full list on our <Link to="/areas" className="underline">service areas page</Link>, or reach us at (250) 896-5971 or hello@wabisabiservices.ca in Victoria, BC.
                  </AccordionContent>
                </AccordionItem>
